...
// ProviderDirective is the minimal provider routing shape AllRouter needs.
...
// that is not configured. Callers should surface it as an AllRouter-origin routing
...
// fields needed by AllRouter policy.
